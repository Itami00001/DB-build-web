...
/**
 * Исправление имен таблиц для Sequelize
 */
async function fixTableNames() {
  try {
    console.log("🔄 Исправление имен таблиц...");
    ...
    // Создаем таблицы с правильными именами для Sequelize
    ...
    // Проверяем результат через модели Sequelize
    ...
    console.log("🎉 Имена таблиц исправлены!");
