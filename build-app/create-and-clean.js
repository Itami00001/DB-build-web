...
/**
 * Создание таблиц и очистка данных
 */
async function createAndClean() {
  try {
    console.log("🔄 Создание таблиц и очистка данных...");
    ...
    console.log("🎉 Создание таблиц и очистка данных завершены!");
