...
/**
 * Исправленная версия принудительного сброса с правильным SQL синтаксисом
 */
async function forceReset() {
  try {
    console.log("🔄 Исправленная принудительная очистка базы данных...");
    ...
    // Создаем категории с правильным синтаксисом
    ...
    // Создаем материалы с правильным синтаксисом
    ...
    console.log("🎉 База данных полностью исправлена с 10 категориями!");
