...
/**
 * Создание правильных таблиц с правильными именами
 */
async function createCorrectTables() {
  try {
    console.log("🔄 Создание правильных таблиц...");
    ...
    console.log("🎉 Создание правильных таблиц завершено!");
