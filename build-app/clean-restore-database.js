...
/**
 * Полная очистка и восстановление базы данных
 */
async function cleanRestoreDatabase() {
  try {
    console.log("🔄 Полная очистка и восстановление базы данных...");
    ...
    await db.materialCategories.destroy({ where: {} });
    ...
    await db.sequelize.query('ALTER SEQUENCE "user_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "materialcategories_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "materials_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "advertisements_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "orders_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "transactions_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "carts_id_seq" RESTART WITH 1');
    await db.sequelize.query('ALTER SEQUENCE "reviews_id_seq" RESTART WITH 1');
    ...
    console.log("🎉 База данных успешно очищена и восстановлена!");
    ...
    console.error("❌ Ошибка при очистке и восстановлении базы данных:", error);
    process.exit(1);
  }
}

cleanRestoreDatabase();
