...
/**
 * Принудительное пересоздание всех таблиц и данных
 */
async function forceRecreateAll() {
  try {
    console.log("🔄 Принудительное пересоздание всех таблиц и данных...");
    
    // Подключаемся к базе данных
    await db.sequelize.authenticate();
    console.log("✅ Подключение к базе данных установлено");
    
    // Полностью удаляем все таблицы с materials в названии
    ...
    // Сбрасываем кэш Sequelize
    await db.sequelize.query('DISCARD ALL');
    console.log("✅ Кэш Sequelize сброшен");
    ...
    console.log("🎉 Принудительное пересоздание завершено!");
    
    process.exit(0);
    
  } catch (error) {
    console.error("❌ Ошибка при принудительном пересоздании:", error);
    process.exit(1);
  }
}
