...
/**
 * Простое восстановление базы данных без транзакций
 */
async function simpleRestoreDatabase() {
  try {
    console.log("🔄 Простое восстановление базы данных...");
    ...
    const cleanupOrder = ['orders', 'orderItem', 'cart', 'transaction', 'advertisements', 'materials', 'materialcategories', 'user'];
