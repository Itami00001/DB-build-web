...
/**
 * Финальная очистка и создание правильных данных
 */
async function finalCleanAndCreate() {
  try {
    console.log("🔄 Финальная очистка и создание правильных данных...");
    
    // Подключаемся к базе данных
    await db.sequelize.authenticate();
    console.log("✅ Подключение к базе данных установлено");
    
    // Полностью удаляем все данные через SQL
    ...
    console.log("🎉 Финальная очистка и создание завершены!");
